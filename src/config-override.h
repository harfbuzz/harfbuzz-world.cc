...
#undef HB_NO_STYLE        /* hb_style_get_value for the info tab */
#undef HB_NO_META         /* OpenType meta entries for the info tab */
#undef HB_NO_VERTICAL     /* vertical metrics reported by the info tab */
