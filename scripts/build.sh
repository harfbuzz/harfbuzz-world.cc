...
em++ \
  ...
  -sEXPORTED_FUNCTIONS='["_web_render_svg","_web_render_pdf","_web_render_raster","_web_shape_json","_web_subset","_web_font_family","_web_font_axes","_web_set_variations","_web_set_foreground","_web_set_background","_web_free_string","_malloc","_free"]' \
